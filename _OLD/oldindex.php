...
$today= date("D");	//If today is Fri run psudo_cron
if ($today=="Fri") {
//psudo_cron();
//If for some reson the regular cron does not run you can enable the
//psudo_cron above by removing the comment characters, then the first person
//to login on Friday afternoon will fire it off.
}
...
color:#ffcc00;
background-image:url('Zchapel.jpg');
font-style:italic;
font-size:30px;
border-style:solid;
border-width:2px;
