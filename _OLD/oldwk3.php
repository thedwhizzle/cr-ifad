...
<meta content="text/html; charset=ISO-8859-1" http-equiv="content-type"><title>wk3</title>
...
mysql_query("UPDATE players2 SET MON='$mon',WED='$wed',FRI='$fri' WHERE LAST_NAME='$Lname'");
}
...
<form name="input" action="wk3.php" method="post"><br>
...
<?php
$result = mysql_query("SELECT * FROM players2 ORDER BY LAST_NAME") or die(mysql_error());
