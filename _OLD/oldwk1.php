...
<meta content="text/html; charset=ISO-8859-1" http-equiv="content-type"><title>wk1</title>
...
connectDB();
if (($today=="Fri")&& ($hd_flag=="yes")){		//Friday after the cron runs
mysql_query("UPDATE players SET MON='$mon',WED='$wed',FRI='$fri' WHERE LAST_NAME='$Lname'");
}
...
mysql_query("UPDATE players SET WED='$wed',FRI='$fri' WHERE LAST_NAME='$Lname'");
}
elseif (($today=="Tue")||($today=="Wed")){
mysql_query("UPDATE players SET FRI='$fri' WHERE LAST_NAME='$Lname'");
}
}
...
<h4> No updates within 24hrs of next play day.</h4>
<hr size="5" noshade="noshade">   

<h2>Put a check-mark by the days you want to play!</h2>
<div align="right" size="80"><br>
<form name="input" action="wk1.php" method="post"><br>
<hr size="5" noshade="noshade">
...
if (($today=="Fri")&& ($hd_flag=="yes")){		//Friday after the cron run
echo"MON <input type=\"checkbox\" name=\"MON\" value=\"YES\"  /><br>";
echo"WED <input type=\"checkbox\" name=\"WED\" value=\"YES\"  /><br>";
echo"FRI <input type=\"checkbox\" name=\"FRI\" value=\"YES\"  /><br>";
}
elseif ($today=="Sat"){
echo"MON <input type=\"checkbox\" name=\"MON\" value=\"YES\"  /><br>";
echo"WED <input type=\"checkbox\" name=\"WED\" value=\"YES\"  /><br>";
