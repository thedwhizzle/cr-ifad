...
mysql_query("UPDATE players1 SET MON='$mon',WED='$wed',FRI='$fri' WHERE LAST_NAME='$Lname'");
}
...
<form name="input" action="play2.php" method="post"><br>
...
<?php
$result = mysql_query("SELECT * FROM players1 ORDER BY LAST_NAME") or die(mysql_error());
